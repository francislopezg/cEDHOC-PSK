...
#define EX_AAD_3B_PSK_SIZE AS_BSTR_SIZE(HASH_SIZE) + CRED_I_SIZE + CRED_R_SIZE + ID_CRED_PSK_SIZE
...
#define TH4_PSK_INPUT_SIZE                                                        \
	(AS_BSTR_SIZE(HASH_SIZE) + AS_BSTR_SIZE(ID_CRED_PSK_SIZE) + CRED_I_SIZE + CRED_R_SIZE + PLAINTEXT3B_PSK_SIZE)
